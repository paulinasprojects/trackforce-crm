...
const GettingStarted = () => {
  return (
    <section className="text-white md:my-[80px] my-[40px] xl:mx-[80px] md:mx-[40px] mx-[24px]">
      <h2 className="lg:text-[48px] md:text-[40px] text-[32px] font-medium text-center">Getting Started with TrackForce CRM Application</h2>
