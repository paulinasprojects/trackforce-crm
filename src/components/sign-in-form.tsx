  ...
  return (
    <div className="bg-[#0a0c16] w-full xl:h-full h-screen">
      <div className="xl:py-12 py-[158px]">
        <Card className="md:w-[740px] w-[327px]  wrapper mx-auto rounded-[30px]">
          <CardContent>
            <div>
              <div className="flex flex-col items-center gap-[16px] mt-[44px]">
                ...
                <button className="mt-[16px] inline-flex items-center justify-center gap-2 bg-[#242424] text-white border border-[#878787] px-3 py-2 rounded-lg w-full">
                  <FcGoogle />
                  <span className="text-white text-[16px] leading-[150%]">or Sign in with Google</span>
                </button>
                <div className="inline-flex items-center gap-2">
                  <div className="h-[1px] md:w-[304px] w-[115px] bg-[#606060]" /> <span className="text-white text-[16px]">Or</span> <div className="h-[1px] md:w-[304px] w-[115px] bg-[#606060]" />
                </div>
              </div>
              <div className="mt-7">
                <form onSubmit={handleSubmit(onSubmit)} id="sign-in-form">
                  <div className="flex flex-col gap-5">
                    ...
                    <Controller
                      ...
                      render={({ field, fieldState }) => (
                        <div className="flex flex-col gap-2">
                          <label htmlFor="" className="text-white text-[16px] font-medium leading-[150%]">Password</label>
                          <input
                            {...field}
                            type="password"
                            aria-invalid={fieldState.invalid}
