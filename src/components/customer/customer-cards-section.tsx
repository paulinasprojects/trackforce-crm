...
const CustomerCardsSection = () => {
  return (
    <section className="bg-[#050709] my-20 xl:mx-20 md:mx-16 mx-6">
      <div className=" flex flex-col gap-2 items-center">
        <h1 className="lg:text-5xl text-headingMedium font-medium leading-lg lg:text-start text-center text-white">Customer Stories and Success</h1>
