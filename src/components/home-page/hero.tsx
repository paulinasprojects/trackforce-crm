...
const Hero = () => {
  return (
    <section className='md:mt-[56px] md:mx-0 mx-6 md:ml-5 lg:ml-[40px] xl:ml-[80px]'>
      <div className='flex md:flex-row sm:flex-col md:justify-between  gap-[56px]'>
        <div className='text-white pt-[53px] flex flex-col items-center md:items-start text-center md:text-left'>
          <ChangeLogButton />
          <p className="xl:text-[64px] lg:text-[48px] sm:text-[32px]  leading-[120%]">Empower Your <br /> Business with <br /> Smarter Customer <br /> Management</p>
          <span className=" text-sm md:text-[16px] lg:text-lg mt-6">Streamline your sales, marketing, and customer service operations with <br className="hidden xl:block" />  an all-in-one CRM platform designed <br className="hidden xl:hidden lg:block" /> to help you grow faster and serve your customers better.</span>
        ...
        <div className="border-t-[16px] outline outline-2 outline-[#383838] border-b-[16px] border-l-[16px] border-[#141515] md:border-r-0 sm:border-r-[16px] rounded-tl-[30px] rounded-bl-[30px] md:rounded-tr-[0px] md:rounded-br-[0px] sm:rounded-tr-[30px] sm:rounded-br-[30px]">
          <img src="/hero-image.png" alt="" className="hidden md:block w-full h-full" />
          <img src="/hero-image-mobile.png" alt="" className="block md:hidden w-full" />
        </div>
      </div>
    </section>
  )
