    ...
    <section className="md:my-[100px] my-[40px] xl:mx-[80px] md:mx-[40px] mx-[24px]">
      <div className="grid lg:grid-cols-2 items-center gap-12">
        <div className="flex flex-col gap-6 ">
          <h2 className=" lg:text-[48px] text-[32px] font-medium text-center lg:text-start leading-[120%] text-white">What Our Customers Are <br className="hidden xl:block" /> Saying</h2>
